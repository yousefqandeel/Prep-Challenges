...
function gradesAvg(arr) {
    ...
    arr.forEach(element => {
        ...
        element["gradsList"].forEach(element2 => sum = sum + element2);
        let z = { "firstName": element["firstName"], "lastName": element["lastName"], "gradsList": element["gradsList"], "avg": sum / element["gradsList"].length };
        newarr.push(z);
